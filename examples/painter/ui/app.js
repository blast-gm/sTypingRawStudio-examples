...
(function () {
  ...
  window.addEventListener('keydown', (e) => {
    ...
    // preventDefault resolve DEPOIS de aberto). Bug relatado no Smart
    // Cleaner: o botao da mesa digitalizadora mapeado pra "segurar
    // espaco" (pan) abria um dropdown sozinho sempre que ele estava
    // com foco - mesmo risco aqui, mesma correcao.
