...
(function () {
  ...
  // Um <select> (ex: modelSelect, cleanMode) CONTINUA com foco depois
  // de escolher uma opcao - o navegador trata espaco com um select
  // focado como comando NATIVO dele (abrir/avancar a opcao), antes
  // disso sequer chegar no keydown abaixo - nao tem "preventDefault"
  // que resolva isso a partir do listener de baixo, porque o
  // comportamento acontece no proprio elemento focado. Ao trocar de
  // opcao, tira o foco do select na hora - nenhum select desta
  // extensao precisa continuar focado depois de escolhido, e assim
  // segurar espaco pra navegar o canvas logo em seguida funciona sem
  // ficar trocando a opcao sozinho.
